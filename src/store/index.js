...
export default createStore({
  state: {
    ...
    services: [
      {
        ...
        description:'Highly responsive FrontEnd and backend software solutions',
        iconClass: 'bi bi-phone'
      },
      {
        id: 2,
        title: 'Architectural design',
        description:'Functional and aesthetically pleasing architectural designs',
        iconClass: 'bi bi-pen'
      },
      {
        id: 3,
        title: 'Mobile and Desktop Applications',
        description:'High performance mobile and desktop application development',
    ...
    adminInfo: 
      {
        bioOutro: 'Growing up in the military environment has taught me the importance of orderliness, courage, punctuality and discipline.',
        bioIntro: 'I was born in the Nigerian Defence Academy, Kaduna state. I did my primary and secondary education in Kaduna state then I attended School of Basic and Remedial Studies Funtua where I started IJMB in the year 2016. I left in 2017 when I got Admission into the Federal University of Technology Minna in Niger State where I started studying Architecture before I transfered to Caleb University Lagos in the year 2020 because of ASUU strike.',
        bioData: [
          {
            title: 'Age',
            value: '23 years'
    ...
    portfolioProjects: [
      {
        ...
        description: 'I was given a sketch of the floor plan by an Architect to develop a complete set of working drawings for the project. I was also the one that designed the facade of the building. For this project I used AutoCAD, Sketchup and Vray.',
      ...
      },
      {
        ...
        location: 'Kaduna State',
        date: 'Oct, 2022',
        description: 'Design of a Residential Housing Estate for Mr. Abdullahi Abdulrazak in Kaduna State. This design has 6 Units of 5 bedroom detached apartments and 14 units of 5 bedroom terrace apartments.',
        desc_title: 'Proposed 14 x 5bedroom terrace apartments and 6 x 5bedroom detached housing estate edsign',
        category: 1,
        productImages: [
          {
            id: 1,
      ...
      },
      {
        ...
        client: 'Nigerian Defence Academy Civilian Staff Multipurpose Coorperative Society',
        date: 'Dec, 2021',
        location: 'Nigerian Defence Academy Old Site, Kaduna state',
        description: 'Design of a shopping center for the Nigerian Defence Academy Civilian Staff Multipurpose Coorperative Society. This project has 3 units of shops, a minimart and 2 storage rooms.',
      ...
      },
      {
        ...
        date: 'Jan 2021',
        description: 'This is a design of a mix-use building having an Architectural firm and a 4 bedroom apartment.',
      ...
      },
      {
        ...
        date: 'Jan, 2021',
        description: 'Design of a three Bedroom bungalow for Mr. Garba Usman Musa at Tunga residential area of Niger State.',
        desc_title: 'Proposed 3 bedroom bungalow design for Mr. Garba Usman Musa',
        category: 1,
        productImages: [
          {
            id: 1,
      ...
      {
        id: 6,
        title: 'Proposed Contemporary 3 bedroom bungalow design for Mr. Garba Usman Musa',
        
        imageSrc: 'uncle-gambo-contemporary.jpg',
        client: 'Mr. Garba Usman Musa',
        location: 'Tunga, Niger state',
        date: 'Jan, 2021',
        description: 'Design of a Contemporary three Bedroom bungalow for Mr. Garba Usman Musa at Tunga residential area of Niger State.',
        desc_title: 'Proposed contemporary 3 bedroom bungalow design for Mr. Garba Usman Musa',
        category: 1,
        productImages: [
          {
            id: 1,
      ...
      {
        id: 7,
        title: 'Proposed 6 x 2 bedroom terrace apartment design for Cdr. IU Umoh',
        
        imageSrc: 'aqs.png',
        client: 'Cdr. IU Umoh',
        date: 'Oct, 2022',
        description: 'Design of a 6 x 2 bedroom terrace apartment for Naval Cdr. IU Umoh',
      ...
      },
      {
        ...
        client: 'School Project',
        date: 'April, 2022',
        description: 'Design of a commercial building having a multi level car park, cinema, restaurant, supermarket and lettable office spaces.',
